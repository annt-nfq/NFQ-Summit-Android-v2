...
val LabelGrey = Color(0x80231F20)
...
val PrimaryContainerLight = Color(0xFFFFC59B)
val OnPrimaryContainerLight = Color(0xFF001d36)

val SecondaryLight = Color(0xFF535f70)
val OnSecondaryLight = Color(0xFFffffff)
val SecondaryContainerLight = Color(0xFFF8F8F9)
...
// Dark
val PrimaryDark = Color(0xFFD37C3C)
val OnPrimaryDark = Color(0xFF003258)
val PrimaryContainerDark = Color(0xFFDA5B00)
